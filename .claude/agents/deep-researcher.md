...
description: Use this agent EXCLUSIVELY for external internet research when web searches and online documentation analysis are required. NEVER use for internal codebase analysis, file merging, or data verification. Examples: <example>Context: User needs to evaluate external technologies through web research. user: 'Research the best state management libraries for React' assistant: 'I'll use the deep-researcher agent to search the web, analyze online documentation, and synthesize findings from external sources.' <commentary>Internet research for technology evaluation requires web searches and external documentation.</commentary></example> <example>Context: User needs online best practices research. user: 'What are the current best practices for implementing WebSockets?' assistant: 'Let me engage the deep-researcher agent to search online resources and gather current best practices from web sources.' <commentary>External research requires internet searches and online documentation analysis.</commentary></example> <example>Context: WRONG USAGE - Internal file work. user: 'Verify data retention in the merged file' assistant: 'I'll use the master-orchestrator to analyze and verify the internal file merge.' <commentary>Internal file analysis does NOT require internet research - use master-orchestrator.</commentary></example>
color: orange
model: opus
---
